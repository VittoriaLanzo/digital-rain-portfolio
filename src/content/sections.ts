...
Stack: React 18 + TypeScript (strict), Vite, React Three Fiber, Drei, React Router v6, shadcn/ui (contact form only). The WebGL canvas is a full-viewport R3F Canvas with logarithmicDepthBuffer, performance={{ min: 0.5 }}, and a far plane at 400 units. Everything outside the canvas is standard React DOM.
